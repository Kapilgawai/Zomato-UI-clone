...
const proOff = offers.length>1?offers[0].text:"offer soon";
      ...
      {bottomContainers && bottomContainers.length > 0 && (
        <div>
          ...
          <div className="explore-bottom">
            <img
              // src={bottomContainers[0]?.bottomContainers?.[0]?.text}
              src={bottomContainers[0]?.image.url}
              style={{ height: "18px" }}
              alt={bottomContainers[0]?.text}
            />
            <div className="rest-bottom-text">{bottomContainers[0]?.text}</div>
          </div>
        </div>
      )}
    </div>
